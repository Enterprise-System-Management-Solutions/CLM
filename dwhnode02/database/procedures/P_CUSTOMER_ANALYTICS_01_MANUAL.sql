--
-- P_CUSTOMER_ANALYTICS_01_MANUAL  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.P_CUSTOMER_ANALYTICS_01_MANUAL (P_PROCESS_DATE VARCHAR2) IS
...
BEGIN
    ...
    VDATE AS SNAPSHOT_DATE, 
    VDATE+1 AS PROCESSING_DATE 
