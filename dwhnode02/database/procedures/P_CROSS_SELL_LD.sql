--
-- P_CROSS_SELL_LD  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.P_CROSS_SELL_LD IS
...
WHERE LU_DATE_KEY  =(SELECT DATE_KEY FROM DATE_DIM WHERE TRUNC(DATE_VALUE) = TRUNC(SYSDATE-1))
GROUP BY MSISDN
)A
LEFT OUTER JOIN
