--
-- SP_LD_CROSSSELL_LD_MANUAL_OLD  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_CAMPAIGN_USER01.SP_LD_CROSSSELL_LD_MANUAL_OLD (P_DATE VARCHAR2)  IS
